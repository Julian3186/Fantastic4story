...
func chapterOne() {
    ...
    func bathroom (walksToTheBathroom: Bool) -> String {
    ...
    enum  Breakfast {
        ...
        func part0ne() {
            var breakfast: Breakfast = .pancakes
            var breakfast1: Breakfast = .eggs
            var breakfast2: Breakfast = .bacon
            var myString: String? = "Chapter One"
